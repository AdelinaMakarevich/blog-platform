...
import {
  ...
  deleteTagPost,
  clearFormPost,
} from '../../store/actions/CreatePostAction'
...
const CreatePost = () => {
  ...
  const onCreatePost = (e) => {
    e.preventDefault()
    const tags = [...tagList, tagPost]
    setCreatePost(true)
    if (titlePost.trim() && descriptionPost.trim() && textPost.trim() && valid) {
      if (!slug) {
        dispatch(fetchCreatePost(userToken, titlePost, descriptionPost, textPost, tags))
      } else {
        ...
        <div className={classes['wrapper']}>
          ...
          <form className={classes['form']}>
            ...
            <fieldset className={classes['fieldset']}>
              ...
              <div className={classes['create-tag']}>
                <div className={classes['tag']}>
                  <input
                    value={tagPost}
                    onInput={(e) => {
                      dispatch(setTagPost(e.target.value))
                    }}
              ...
              {tag ? <span className={classes['span']}>заполните</span> : null}
              {tagInclude ? <span className={classes['span']}>уже существует</span> : null}
            </fieldset>
